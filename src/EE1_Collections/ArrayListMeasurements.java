...
public class ArrayListMeasurements {
    ...
    //Объявление констант в мейне и затем их использование в других классах - странное решение.
    //Мейн - это всего лишь запуск, это сторона клиента. В нем могут задаваться данные для использования в приложении
